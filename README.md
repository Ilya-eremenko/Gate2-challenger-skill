...
It routes Gate 2, 1st Stream Review, 2+ Stream Review, Progress Review, and Gate 3 documents to stage-specific rubrics while sharing the same evidence, output, synthesis, and verdict contracts.
